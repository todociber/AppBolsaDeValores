 ...
 */
public class GetOrdenesPadre {

    BufferedReader in = null;

    public int  error,erroCode,result;
    public String idOrden,idCliente,TokenPush;
    public Context context;

    public GetOrdenesPadre(Context context, String token, String idCliente, String idOrden) {

        String urlBase = context.getResources().getString(R.string.urlSistemaASI);
        String  url = urlBase+"api/getOrdenesPadre/"+idOrden+"/"+idCliente+"?token="+token;
        ...
        try {
            ...
            if (error == 0) {
                ...
                ProcesarOrdenesPadre procesarOrdenesPadre = new ProcesarOrdenesPadre(context,jsdonData);
