...
public class PutCancelarOrden {
    ...
    public String TokenPush,idOrden,nombreCliente,ApellidoCliente,idCliente,motivo,idUsuario;
    public Context context;

    public PutCancelarOrden(String TokenPush,Context context,String idOrden,String nombreCliente,String apellidoCliente, String idCliente, String motivo, String idUsuario){
        this.motivo = motivo;
    ...
    public int EjecutarCancelacion(){

        try {
            String urlBase = context.getResources().getString(R.string.urlSistemaASI);
            String  url = urlBase+"api/cancelOrder";
            JSONObject jsonObj = new JSONObject();
            jsonObj.put("motivo",motivo);
            ...
            Log.d("objero Cancelar",jsonObj.toString());
            ...
            Log.d("Respuesta Cancelar",jsonObject.toString());
            error = jsonObject.getInt("ErrorCode");
            System.out.println("RECIBIDO "+jsonObject.toString());
            if (error ==0){
