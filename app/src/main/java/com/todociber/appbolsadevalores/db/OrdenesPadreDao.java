...
/** 
 * DAO for table ORDENES_PADRE.
*/
public class OrdenesPadreDao extends AbstractDao<OrdenesPadre, Long> {

    public static final String TABLENAME = "ORDENES_PADRE";

    /**
     * Properties of entity OrdenesPadre.<br/>
    ...
    */
    ...
    public OrdenesPadreDao(DaoConfig config) {
        super(config);
    }
    
    public OrdenesPadreDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ORDENES_PADRE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ORDENES_PADRE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, OrdenesPadre entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public OrdenesPadre readEntity(Cursor cursor, int offset) {
        OrdenesPadre entity = new OrdenesPadre( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, OrdenesPadre entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(OrdenesPadre entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(OrdenesPadre entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
