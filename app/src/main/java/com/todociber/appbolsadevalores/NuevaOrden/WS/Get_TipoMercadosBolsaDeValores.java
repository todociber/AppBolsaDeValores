...
import com.todociber.appbolsadevalores.NuevaOrden.WS.ProcesarWS.ProcesarGet_TipoMercados;
 ...
 */
public class Get_TipoMercadosBolsaDeValores {
    ...
    public Get_TipoMercadosBolsaDeValores(Context context) {

        String urlBase = context.getResources().getString(R.string.urlApiBolsa);
        String  url = urlBase+"GetTipoMercado";
        ...
        try {
            ...
            if (error == 0) {
                ...
                ProcesarGet_TipoMercados procesarGet_tipoMercados = new ProcesarGet_TipoMercados(context,jsonObject.getJSONArray("tipoMercados"));
