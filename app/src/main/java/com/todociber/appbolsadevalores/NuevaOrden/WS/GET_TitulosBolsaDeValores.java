...
import com.todociber.appbolsadevalores.NuevaOrden.WS.ProcesarWS.ProcesarGet_Titulos;
 ...
 */
public class GET_TitulosBolsaDeValores {
    ...
    public GET_TitulosBolsaDeValores(Context context) {

        String urlBase = context.getResources().getString(R.string.urlApiBolsa);
        String  url = urlBase+"GetTitulos";
        ...
        try {
            ...
            if (error == 0) {
                ProcesarGet_Titulos procesarGet_titulos = new ProcesarGet_Titulos(jsonObject.getJSONArray("Titulos"),context);
