 ...
 */
public class adapterSpinnerCasa  extends BaseAdapter {
    ...
    public adapterSpinnerCasa(Context context, Cursor cursor) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = inflater.inflate(R.layout.detalle_spinner_casa, null);
