 ...
 */
public class GET_Afiliaciones {
    public int  error,erroCode,result=2;
    public String Email,Password,TokenPush;
    public Context context;
    BufferedReader in = null;

    public GET_Afiliaciones(Context context,String idCliente,String token) {

        String urlBase = context.getResources().getString(R.string.urlSistemaASI);
        String  url = urlBase+"api/getCasasProceso/"+idCliente+"?token="+token;
        ...
        try {
            ...
            if (error == 0) {
                ProcesarAfiliaciones procesarAfiliaciones = new ProcesarAfiliaciones(context,jsonObject.getJSONArray("data"));
