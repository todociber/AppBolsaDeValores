 ...
 */
public class GETCasasCorredoras {
    ...
    public GETCasasCorredoras(Context context, String token, String idCliente) {

        String urlBase = context.getResources().getString(R.string.urlSistemaASI);
        String  url = urlBase+"api/getCasasAfiliado/"+idCliente+"/"+"?token="+token;
        ...
        try {
            ...
            if (error == 0) {
                ...
                ProcesarGetCasas procesarGetCasas = new ProcesarGetCasas(context);
                procesarGetCasas.procesarCasasNuevas(jsonObject.getJSONArray("data"));
                result = 0;
            } else if (error == 1) {
                result = 1;
            } else if (error == 2) {
